class Overworld extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('tilesetImage','testtileset.png')
        this.load.tilemapTiledJSON('tilemapJSON','overworld.json')
    }

    create() {
        const map = this.add.tilemap('tilemapJSON')
        const tileset = map.addTilesetImage('test tileset', 'tilesetImage')
        ...
        terrainLayer.setCollisionByProperty({cancollide: true})
